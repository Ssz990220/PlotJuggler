# pj_scene2D Evolution: Experiment → Production

Comparison between the early standalone experiment (`~/ws_plotjuggler/pj_scene2D/`)
and the production module (`plotjuggler_core/pj_scene2D/`).

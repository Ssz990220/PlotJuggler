...
// Verifies the parser-less pipeline dispatch in Scene2DDockWidget.
//
...
TEST(Scene2DDockDispatch, ImageReturnsBuiltInJpegPipeline) {
  auto pipeline = PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kImage);
...
TEST(Scene2DDockDispatch, DepthImageHasNoBuiltInPipeline) {
  ...
  auto pipeline = PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kDepthImage);
...
TEST(Scene2DDockDispatch, NonImageTypesHaveNoBuiltInPipeline) {
  ...
  EXPECT_EQ(PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kPointCloud), nullptr);
  EXPECT_EQ(PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kImageAnnotations), nullptr);
  EXPECT_EQ(PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kFrameTransforms), nullptr);
  EXPECT_EQ(PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kNone), nullptr);
}
...
TEST(Scene2DDockDispatch, VideoFrameHasNoBuiltInPipeline) {
  ...
  EXPECT_EQ(PJ::Scene2DDockWidget::makePipelineFor(PJ::sdk::BuiltinObjectType::kVideoFrame), nullptr);
}

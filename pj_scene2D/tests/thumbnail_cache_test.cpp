...
const std::string kTest480p = "pj_scene2D/testdata/test_480p.mp4";
const std::string kTest1080p = "pj_scene2D/testdata/test_1080p.mp4";
...
TEST_F(ThumbnailCacheTest, BuildFromInvalidFileNoCrash) {
  ...
  cache.buildAsync("pj_scene2D/PLAN.md", 5.0);
  waitForBuild(cache);

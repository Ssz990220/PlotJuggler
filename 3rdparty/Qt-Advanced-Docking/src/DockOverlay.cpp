...
//============================================================================
// PJ4-Wayland: parent the overlay to the manager's top-level window and drop
...
//============================================================================
// PJ4-Wayland: see CDockOverlay above for the rationale.
...
{
	// PJ4-Wayland: devicePixelRatioF() walks the parent chain; the original
